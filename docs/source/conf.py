...
# shutdown_candidate_predictor documentation build
...
from shutdown_candidate_predictor import __version__ as release

# -- Project information -----------------------------------------------------

project = "shutdown_candidate_predictor"
copyright = "2020, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "shutdown_candidate_predictordoc"
...
latex_documents = [
    (
        master_doc,
        "shutdown_candidate_predictor.tex",
        "shutdown_candidate_predictor Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "shutdown_candidate_predictor",
        "Project shutdown_candidate_predictor codebase.",
        "Data-Science",
    )
]
